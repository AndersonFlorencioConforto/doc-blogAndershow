...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">blog-ander-show documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-f2d4d1d3bc5fbb434ff7880daf66fa69"' : 'data-target="#xs-components-links-module-AppModule-f2d4d1d3bc5fbb434ff7880daf66fa69"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-f2d4d1d3bc5fbb434ff7880daf66fa69"' :
                                            'id="xs-components-links-module-AppModule-f2d4d1d3bc5fbb434ff7880daf66fa69"' }>
                                            <li class="link">
